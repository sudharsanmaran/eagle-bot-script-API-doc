...
### Examples
- Send a new email using JSON format. Here is an example of how to call this API.
...
### Examples
- #### Create a new message draft using JSON format
#### Request
Here is an example of the request.
```http request
...
- #### Create message draft that includes custom message headers
- 
#### Request
...
- #### Create a new message draft using MIME format
#### Request
```http request
POST https://graph.microsoft.com/v1.0/me/messages
